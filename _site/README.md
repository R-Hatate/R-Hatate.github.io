...
[https://ageitgey.github.io/amplify/](https://ageitgey.github.io/amplify/2016/03/08/example-post.html)
or
...
Here's how this looks to the user (as rendered by [WebPageTest](https://www.webpagetest.org/)):
...
*On windows*
If on windows you will need the ruby devkit available here: [rubyinstaller](https://rubyinstaller.org/).
...
[https://localhost:4000/](https://localhost:4000/) to see your site!
...
https://localhost:4000/#development=1
...
a https://schema.org NewsArticle schema. See `_includes/metadata.json` for the
